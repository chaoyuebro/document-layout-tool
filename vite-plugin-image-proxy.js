    ...
    return {
        ...
        configureServer: function (server) {
            ...
            server.middlewares.use(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                var url, imageUrl, response, contentType, mimeType, base64, error_1;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            // 只处理 /api/proxy/image 请求
                            if (!((_a = req.url) === null || _a === void 0 ? void 0 : _a.startsWith('/api/proxy/image'))) {
                        ...
                        case 2:
                            ...
                            console.log("\u2705 [\u540E\u7AEF\u4EE3\u7406] \u56FE\u7247\u4E0B\u8F7D\u6210\u529F: ".concat(base64.length, " \u5B57\u7B26, ").concat(mimeType));
                            // 返回JSON响应
                        ...
                        case 3:
                            error_1 = _b.sent();
                            console.error('❌ [后端代理] 图片下载失败:', error_1);
                            res.statusCode = 500;
                            res.end(JSON.stringify({
                                success: false,
